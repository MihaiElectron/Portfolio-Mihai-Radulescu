        ...
        <div className="hero__layout">
          <div className="hero__left">
            ...
            <p className="hero__description">
              Développeur web front-end. Je pilote des interfaces React,
              Redux, TypeScript et Sass de la passerelle d'embarquement
              jusqu'à la mise en production. Présentez votre billet, on
              décolle dans quelques lignes.
            </p>
          </div>
